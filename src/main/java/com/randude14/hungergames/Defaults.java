...
public class Defaults {
	...
	ADMIN_PROFILE(new Permission("hungergame.admin.profile"), ADMIN),
	...
	ADMIN_PROFILE("ADMIN", "/%s profile", "Enables the saving of profile.log for current server session", Perm.ADMIN_PROFILE),
