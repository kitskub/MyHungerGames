...
public class Defaults {
    ...
    public enum Perm {
		...
		ADMIN_ADD_CUBOID(new Permission("hungergame.admin.add.cuboid"), ADMIN),
		ADMIN_ADD_FIXED_CHEST(new Permission("hungergame.admin.add.fixedchest"), ADMIN),
		ADMIN_ADD_CHEST(new Permission("hungergame.admin.add.chest"), ADMIN),
		ADMIN_ADD_CHEST_LOOT(new Permission("hungergame.admin.add.chestloot"), ADMIN),
		ADMIN_ADD_GAME(new Permission("hungergame.admin.add.game"), ADMIN),
		ADMIN_ADD_GAME_SIGN(new Permission("hungergame.admin.add.gamesign"), ADMIN),
		ADMIN_ADD_HELP(new Permission("hungergame.admin.add.help"), ADMIN, "allows the player to view add help page"),
		ADMIN_ADD_INFO_WALL(new Permission("hungergame.admin.add.infowall"), ADMIN),
		ADMIN_ADD_ITEMSET(new Permission("hungergame.admin.add.itemset"), ADMIN),
		ADMIN_ADD_JOIN_SIGN(new Permission("hungergame.admin.add.joinsign"), ADMIN),
		ADMIN_ADD_REWARD(new Permission("hungergame.admin.add.reward"), ADMIN),
		ADMIN_ADD_SPAWNPOINT(new Permission("hungergame.admin.add.spawnpoint"), ADMIN),
		ADMIN_ADD_SPONSOR_LOOT(new Permission("hungergame.admin.add.sponsorloot"), ADMIN),
		ADMIN_ADD_WORLD(new Permission("hungergame.admin.add.world"), ADMIN),
		...
		ADMIN_SET_ENABLED(new Permission("hungergame.admin.set.enabled"), ADMIN),
		ADMIN_SET_FIXED_CHEST(new Permission("hungergame.admin.set.fixedchest"), ADMIN),
		ADMIN_SET_SPAWN(new Permission("hungergame.admin.set.spawn"), ADMIN),
		...
		ADMIN_EDIT_ARENA(new Permission("hungergame.admin.editarena"), ADMIN),
	...
	public 	me.kitskub.hungergames.commands.Command getCommand() {
		return command;
	}
